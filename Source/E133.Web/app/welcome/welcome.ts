...
export class Welcome {
	...
	constructor(router: Router, i18n: I18N, element: Element) {
		...
		this.recipeGroups.push({ label: "Desserts", recipes: [
			...
			{ id: "57099aad44fd46200ef99030", title: "Crème pâtissière", imageUrl: "http://www.ricardocuisine.com/pictures/cache/6d668ea38cb56db9a2de3dc3200ad534_w500_h675_sc.jpg" },
