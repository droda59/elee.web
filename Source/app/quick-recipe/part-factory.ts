...
import {PartDto, TextPartDto, ActionPartDto, TimerPartDto, IngredientPartDto, QuantityOfIngredientPartDto, EnumerationPartDto} from "app/quick-recipe/models/quick-recipe";
...
export class PartFactory {
    ...
    static createPart(stepId: number, type: string, dto?: PartDto): Part {
        switch (type) {
            ...
            case EnumerationPart.type: return new EnumerationPart(stepId, <EnumerationPartDto>dto);
        }
    }
}
